...
1. Get the <LicenseKey/> for the account you want to report data to.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        **Required.** A <LicenseKey/> for the account you want to report data to. If this is provided as both a header and a query parameter, the values must match.
      </td>
    </tr>
