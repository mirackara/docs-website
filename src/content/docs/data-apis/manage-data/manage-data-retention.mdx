...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        All ([see details](#browser-namespaces))
      </td>
...
All browser namespaces have the same default retention period. Details on the browser namespaces and the events they report: 
...
For more about these events, see [the browser events in the data dictionary](https://docs.newrelic.com/attribute-dictionary/?dataSource=Browser+agent).
</Collapser>
