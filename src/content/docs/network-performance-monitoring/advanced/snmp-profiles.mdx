...
Profiles define what SNMP OIDs you want `ktranslate` to attempt to collect and send to your New Relic account. This document explains how to modify an existing profile or create a new profile.
