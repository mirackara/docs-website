...
## Create a NRQL alert condition from a policy [#create-alert-condition]
...
Follow these steps.
    ...
    <Collapser
        ...
        >
      1. Choose the **Build a query** option. This option enables you to identify a signal and add a NRQL query. See [How to use NRQL: the mechanics of querying](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-how-nrql-works/) if you need help for adding a query.
    ...
    <Collapser
        ...
        Add the details of the alert condition. Add a name to the alert condition to find an use it easily. Then, connect it to a policy. You can select an existing one or create a new policy. 

        If you select **New policy**:
        ...
        If you've selected **Existing policy**, click **Save condition** once you've chosen a policy.
...
2. In the left pane, select **More views > Metrics explorer** and add your configuration.
3. Click the <Icon name="fe-more-horizontal"/> icon on the right corner and select **Create alert condition**.
...
<CollapserGroup>
    <Collapser
      ...
      The query is already built with the data you've previously configured.
    ...
    <Collapser
        ...
        Here, you can configure the [data aggregation](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/choose-your-aggregation-method/), the [gap-filling strategy](#data-gaps), and the [evaluation delay](#evaluation-delay).
