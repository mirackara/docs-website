...
2. Select an existing policy or click **+ New alert policy** to [create a new policy](/docs/alerts-applied-intelligence/new-relic-alerts/alert-policies/create-edit-or-find-alert-policy). Note that editing an existing condition can result in [resetting its evaluation](#evaluation-resets).
...
<Collapser
  ...
  1. Choose one of these options:
        ...
        * **Golden signal or metric**. This option allows you to create NRQL alert conditions without knowing any NRQL. Choose the options that adjust to your needs.
