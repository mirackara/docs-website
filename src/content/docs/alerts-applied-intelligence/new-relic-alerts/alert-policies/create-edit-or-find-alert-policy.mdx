...
A [policy](/docs/alerts-applied-intelligence/applied-intelligence/incident-intelligence/basic-alerting-concepts/) is a group of one or more conditions. This document explains how to create a policy and how to view existing policies. You can also use the [REST API](/docs/alerts/rest-api-alerts/new-relic-alerts-rest-api/rest-api-calls-new-relic-alerts).
...
<CollapserGroup>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**, then select a channel.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Alert conditions (Policies) > (select a policy) > Notification channels**.
  ...
  >
    To check whether a notification channel has any [policies assigned](/docs/alerts/new-relic-alerts-beta/managing-notification-channels/add-or-remove-policy-channels) to it: Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI > Channels**.
  ...
  >
    ...
    3. Follow standard procedures to complete the [basic setup process](/docs/alerts-applied-intelligence/new-relic-alerts/get-started/your-first-nrql-condition/).
  </Collapser>
  ...
  <Collapser
    id="incidents"
    title="Change how threshold incidents roll up into issues"
  >
  ...
  >
    ...
    1. From **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts**.
    2. On the left under **Incident intelligence > Sources**, then click **Alerts**.
