...
For a screenshot of the UI, see below. 

<CollapserGroup>
  <Collapser
    id="basic-correlate-attributes-ui"
    title="Correlate by attributes UI"
  >
...
<CollapserGroup>
  <Collapser
    id="basic-filter-values-ui"
    title="Filter by values UI"
  >
...
The correlation time range is set to 20 minutes by default. You can adjust the range between 1 minute and 120 minutes.
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI** > **Decisions**. 
...
<figcaption>
  On the right-hand side of the page, click the **Logic** tab. This gives you an overview of your decision logic.
</figcaption>
...
* **Frequency**: Modifies the minimum number of incidents that need to meet the decision logic for the decision to trigger.
