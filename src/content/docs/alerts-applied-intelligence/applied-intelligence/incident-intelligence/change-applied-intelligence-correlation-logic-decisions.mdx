...
You can reduce noise and improve correlation by building your own custom decisions. To start building a decision, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Alerts & AI**   **Alerts & AI** > **Correlate** > **Decisions**, and click **Create new decision**.
