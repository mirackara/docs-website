...
Next, we'll go into more detail on the two decision builders. 
...
#### Step 1: Correlate by attributes [#basic-step-1]
...
#### Step 2: Filter by specific values [#basic-step-2]
...
#### Step 3: Filter by related entities [#basic-step-3]
...
#### Step 4: Set correlation time range [#basic-step-4]
...
#### Step 5: Testing your rule with simulation [#basic-step-5]
...
#### Step 6: Name and save your decision [#basic-step-6]
