...
The Workflows Log is a feature of New Relic Workflows that provides users a detailed record to keep track of all notifications generated by workflows. This information can be used to troubleshoot issues, monitor workflow performance, and ensure that notifications are being sent to the correct destinations. As a result, users can quickly identify any issues that may arise and take corrective action as needed.

### Accessing the Workflows Log [#accessing-workflows-log]

To access the workflows log, follow these steps:

**Step 1:** Go to New Relic Alerts and AI. 
**Step 2:** From the main menu, select “Workflows”
**Step 3:** From the workflows dashboard, click on “Workflows Log” on the top submenu.
