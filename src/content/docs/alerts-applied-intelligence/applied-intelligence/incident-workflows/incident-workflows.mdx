...
* To modify workflows: `Modify` capabilities for `Applied intelligence > Workflows` and all capabilities for `Applied intelligence > Channels` and `applied_intelligence.create.workflow`.
...
To access the workflows log, go to **[one.newrelic.com > Alerts & AI > Workflows](https://one.newrelic.com/alerts-ai/workflows)**, then click **Issues notification log**.
