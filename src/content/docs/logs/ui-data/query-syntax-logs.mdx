...
```
## Example: Create a dashboard with log data

You can pull data form logs into a graph (ie, dashboard). 
...
- logtype: apache 
- In addition, use our built in log parsing rules (link to parsing rules)
- To create a dashboard, here how. 

## Example: View CDN logs
