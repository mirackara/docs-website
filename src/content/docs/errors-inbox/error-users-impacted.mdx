...
* [Browser](/docs/data-apis/custom-data/custom-events/report-mobile-monitoring-custom-events-attributes/#track-user)
* [Mobile](https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/setuserid/)
