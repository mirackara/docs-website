...
Errors inbox enables you to filter out expected errors for <InlinePopup type="apm" /> entities. You can [mark errors as expected](/docs/apm/agents/manage-apm-agents/agent-data/manage-errors-apm-collect-ignore-or-mark-expected#expected), and filter them out of your inbox to remove noise.
...
<CollapserGroup>
  ...
  >
    ...
    If you've set up [distributed tracing](/docs/distributed-tracing/concepts/quick-start/), and if there are traces related to errors, you'll see options to view trace details. This is a quick way to view trace information without going to the main distributed tracing page:
    ...
    * In the right pane labeled **Distributed trace**, you'll see the trace that's associated with the error displayed on this page. To see the trace's spans in a waterfall view:
        ...
        * Click **Explore** to open an unfiltered waterfall where you can see all the spans.
