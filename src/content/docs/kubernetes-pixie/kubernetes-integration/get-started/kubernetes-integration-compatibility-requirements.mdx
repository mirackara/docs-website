...
Our Kubernetes integration is compatible with Kubernetes versions 1.16 to 1.26. Kubernetes version 1.27.x is currently being offered as an experimental release, full featured compatibility is not yet guaranteed at this time. 
...
Our integration currently supports an experimental release (i.e., we do not guarantee full-fledged support) of the following Kubernetes versions: 
<table>
  <thead>
    <tr>
      <th style={{ width: "300px" }}>
