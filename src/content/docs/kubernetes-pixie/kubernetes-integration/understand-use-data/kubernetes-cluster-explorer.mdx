...
import k8sNavigatorAlerts from 'images/k8s_navigator_alerts.webp'

import k8sNavigatorFeedback from 'images/k8s_navigator_feedback.webp'

import k8sNavigatorFiltering from 'images/k8s_navigator_filtering.webp'

import k8sNavigatorOptions from 'images/k8s_navigator_options.webp'

import k8sNavigatorPods from 'images/k8s_navigator_pods.webp'

import k8sNavigatorToggle from 'images/k8s_navigator_toggle.webp'

import k8sNavigatorAnimation from 'images/k8s_navigator_animated.gif'
...
<Callout title="Deprecated">
  ...
  <figcaption>
    **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Kubernetes cluster explorer > Summary**: Click the toggle to return to the Kubernetes Navigator UI.
  </figcaption>
