...
import k8sNavigatorPreviewToggle from 'images/k8s_navigator_preview_toggle.webp'
...
<Callout title="Preview">
  ...
  <figcaption>
    **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Kubernetes cluster explorer > Summary**: Click the toggle to view the Kubernetes Navigator UI Preview
  </figcaption>
...
The preview supports visualizing the following Kubernetes entity types:
...
Use the drop down filters to select an **Entity Type**, **Metric**, and **Group by**.  These enable you to control what is visualized on the screen.
...
The Kubernetes Navigator UI is in `preview` at the moment with updates and additional features being planned. Please send us your feedback about what you like, dislike, and what other features you'd like to see in this UI.  You can submit feedback directly in New Relic by visiting the **Help > Give Us Feedback** option in the bottom left nav.
