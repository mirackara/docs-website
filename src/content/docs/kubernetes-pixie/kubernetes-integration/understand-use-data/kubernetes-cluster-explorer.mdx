...
## Kubernetes Navigator preview [#navigator-preview]
...
Our Kubernetes Navigator UI builds upon the concept of [New Relic Navigator](https://docs.newrelic.com/docs/new-relic-solutions/new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts/#view-navigator) by enabling users to easily group entities and isolate high resource consumption, capacity issues, and alert status for pods, daemonsets, deployments, Statefulsets, and nodes.
