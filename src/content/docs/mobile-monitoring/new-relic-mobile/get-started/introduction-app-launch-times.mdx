...
To start monitoring launch times for Android, see [Configure app launch time](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-app-launch-time-android-apps).

To start monitoring launch times, see these docs:
* [Android - Monitor app launch time](/docs/mobile-monitoring/new-relic-mobile-android/install-configure/configure-app-launch-time-android-apps).
* [iOS - Monitor app launch time](/docs/mobile-monitoring/new-relic-mobile-ios/configuration/app-launch-times-ios-apps). 
