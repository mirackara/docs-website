...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        You can add non-working comments to your NRQL queries. [Learn more about comments](/docs/query-your-data/nrql-new-relic-query-language/get-started/nrql-syntax-clauses-functions#comments). 
      </td>
    </tr>    
  </tbody>
</table>
