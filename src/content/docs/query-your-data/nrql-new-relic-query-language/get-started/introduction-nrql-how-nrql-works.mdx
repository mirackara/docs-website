...
When writing a NRQL query, you can add comments to a line or section of text. Comments can help your team members better understand and use the queries you make. 
