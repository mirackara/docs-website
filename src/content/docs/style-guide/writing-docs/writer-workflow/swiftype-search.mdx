...
You may want to manually add a new page to the Swiftype index when the crawl is too slow and you want the page available right away. Keep in mind that updating the idex may produce quick results for the docs site, you may experience a lag for the docs in the product UI.
