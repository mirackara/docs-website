...
* Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**, click on **Add an AWS account**, then on **Use metric streams**, and follow the steps.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The <LicenseKey/> associated with the account you wish to export metrics to.
      </td>
...
1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**, and search for the **Stream** accounts.
