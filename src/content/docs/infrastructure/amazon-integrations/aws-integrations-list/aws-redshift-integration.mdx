...
Reported data includes bytes received and bytes transmitted, health status, database connections, latency, and other [metrics](#metrics)). Your Redshift data is available in pre-built dashboards and you can also create [custom queries and charts](/docs/infrastructure/integrations-getting-started/getting-started/use-integration-data-new-relic-insights).
...
To find your integration data, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS** and select one of the Redshift integration links.
