   ...
   <CollapserGroup>
     ...
     >
       ...
       <Callout variant="info">
         There's a known issue with zypper package manager where GPG keys may not be validated as expected in older SLES versions. If you get errors such as `Signature verification failed`, upgrade your infrastructure agent to version 1.44.0 or higher.
       </Callout>
     </Collapser>
   </CollapserGroup>
