...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      Notice that direct connect should also be set to false if `loadBalanced=true` is specified either in the connection string or in the DNS entry as it happens in case of Serverless Atlas Deployments.    </td>
    <td>
      true
    </td>
  </tr>
