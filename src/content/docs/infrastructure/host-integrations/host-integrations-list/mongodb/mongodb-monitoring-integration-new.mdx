...
<CollapserGroup>
  ...
  >
    ...
    Consider increasing the default `scrape_timeout` value to mitigate this issue. For further information regarding the configuration options, check the MongoDB instance [settings](https://docs.newrelic.com/docs/infrastructure/host-integrations/host-integrations-list/mongodb/mongodb-monitoring-integration-new/#instance-settings).
  </Collapser>
</CollapserGroup>
