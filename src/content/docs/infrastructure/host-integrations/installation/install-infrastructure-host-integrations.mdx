...
Please mention that data has to be pulled by the Infra Agent so for example if the below is the scenario , in case of SQL
Host 1 has NR Agent === outbound rule for 1433 port has to be allow

Host 2 has SQL Server where 1433 port === inbound rule for 1433 has to be allow

In this way the Host 1 pulls data from Host 2  
...
<CollapserGroup>
  ...
  <Collapser
    id="apt"
    title={<>Install with apt (<img src={osDebian} title="Debian icon" alt="Debian.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Debian, <img src={osUbuntu} title="ubuntu icon" alt="ubuntu icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Ubuntu)</>}
  >
  ...
  <Collapser
    id="yum"
    title={<>Install with yum (<img src={osAmazonLinux} title="amazon linux.png" alt="amazon linux.png" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>Amazon Linux, <img src={osCentos} title="centos icon" alt="centos icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>CentOS, <img src={osRedhat} title="redhat icon" alt="redhat icon" style={{ height: '32px', width: '32px', verticalAlign: 'middle' }}/>RHEL)</>}
  >
