---
title: Infrastructure Entities hosts
tags:
  - Infrastructure
...
Previously, when navigating to infrastructure, you were redirected outside the [Explorer](/docs/new-relic-one/use-new-relic-one/core-concepts/new-relic-explorer-view-performance-across-apps-services-hosts/), missing capabilities like the Navigator and Lookout. Now, by clicking on infrastructure or hosts, you are directed to the list of all of our host [entities](/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/) in the **list view of Explorer**, and **infrastructure events are displayed in the activity stream**. Our inventory experience has not changed as part of this release.
...
## Access the Infrastructure Entities page [#access-infra-entities]

Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Infrastructure**, then click **Hosts (New)**. Or go to the **Explorer** and select **Hosts**.
