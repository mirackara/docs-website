...
1. Linked dashboards. Within a workload, you can link between dashboards, or add links to external sources like GitHub or Jira. You can also create and add pre-filtered, workload-relevant links to dashboards.
