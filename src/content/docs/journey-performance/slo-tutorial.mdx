...
* Ease future setup: Automatically establish a baseline of performance andreliability for any service with a one-click setup.
...
Ready to learn more about what you can do with New Relic to improve your site performance? Check out our docs on service level management, and learn more about how you can use this feature to optimize your customer experience.

* [Intro to service level management](/docs/service-level-management/intro-slm/)
* [How to consume service levels](/docs/service-level-management/consume-slm/)
* [Set up alerts on service levels](/docs/service-level-management/alerts-slm/)