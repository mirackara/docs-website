...
3. **Authorized New Relic endpoints**: Customer must configure their applicable agents to send their data only to our [FedRAMP-designated endpoints](#overview).
4. **Authorized services and features**: Customer must use only FedRAMP audited and authorized New Relic [services and features](/docs/security/security-privacy/compliance/certificates-standards-regulations/fedramp-moderate/#not-scope).
...
## Overview of FedRAMP-compliant endpoints [#overview]
...
## Agent and ingest API endpoints [#agents]
...
<table>
  ...
  <tbody> 
    ...
    <tr>
      ...
      <td>
        gov-cloud-collector.newrelic.com/
      </td>

      <td>
        Ingest for [AWS VPC Flow Logs](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-vpc-monitoring-integration/) and [RDS Enhanced](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-rds-enhanced-monitoring-integration/).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [Event API ingest](/docs/data-apis/ingest-apis/event-api/introduction-event-api/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Our [Log API](/docs/logs/log-api/introduction-log-api/), used by various agents and integrations.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        gov-metric-api.newrelic.com
        gov-metric-api.newrelic.com/prometheus/
      </td>

      <td>
        Our [Metric API](/docs/data-apis/ingest-apis/metric-api/introduction-metric-api/) for dimensional metrics, used by various agents and integrations.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        gov-mobile-collector.newrelic.com
      </td>

      <td>
        [Mobile agent ingest](/docs/mobile-monitoring/new-relic-mobile/get-started/introduction-mobile-monitoring/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        gov-mobile-crash.newrelic.com
      </td>

      <td>
        [Mobile agent crash report ingest](/docs/mobile-monitoring/mobile-monitoring-ui/crashes/investigate-mobile-app-crash-report/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        gov-otlp.nr-data.net:4318
        gov-otlp.nr-data.net:4317
        gov-otlp.nr-data.net:443
      </td>
    ...
    <tr>
      ...
      <td>
        gov-trace-api.newrelic.com
      </td>

      <td>
        [Trace API ingest](/docs/distributed-tracing/trace-api/introduction-trace-api)
      </td>
    </tr>
  </tbody>
</table>
