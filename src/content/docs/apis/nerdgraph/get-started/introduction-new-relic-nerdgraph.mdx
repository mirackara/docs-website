...
[//]: # (Do NOT change these the URLs of these GraphQL endpoints unless you have the approval of the Unified API team)
...
* For applied intelligence: [Configuring topology for incident correlation](/docs/apis/nerdgraph/examples/topology-nerdgraph-tutorial)
    ...
    <tr>
      ...
      <td>
        * [Create a new browser app](/docs/apis/nerdgraph/examples/browser-monitoring-config-nerdgraph/#create-browser)
        * [Retrieve the JavaScript snippet](/docs/apis/nerdgraph/examples/browser-monitoring-config-nerdgraph/#get-browser-snippet)
        * [Examples of configuring browser monitoring](/docs/apis/nerdgraph/examples/browser-monitoring-config-nerdgraph/#configure-browser-application)
      </td>
    </tr>
