...
import apmTrxTraceDetails from 'images/apm_screenshot-crop_trx-trace-details.png'

import apmIconDb from 'images/apm_icon_icon-db.png'

import apmIconParameters from 'images/apm_icon_icon-parameters.png'

import apmIcoWebTransactions from 'images/apm_icon_ico-web-transactions.png'

import apmRedAlert from 'images/apm_icon_red-alert.png'

import apmYellowAlert from 'images/apm_icon_yellow-alert.png'
