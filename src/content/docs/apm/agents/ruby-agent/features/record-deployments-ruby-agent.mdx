...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The New Relic <LicenseKey/> to use. By default this comes from the definition in the `newrelic.yml` file for the given `rails_env`. This is **not** the same as your [REST API key](/docs/apis/getting-started/intro-apis/access-rest-api-keys).
      </td>
    </tr>
