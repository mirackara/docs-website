...
<CollapserGroup>
  ...
  >
    ...
    Response codes that are expected will not affect your applications apdex or error alerts, but will still be recorded.
    ...
    You can also add response codes as HTTPs, as `http.StatusAccepted` above.
