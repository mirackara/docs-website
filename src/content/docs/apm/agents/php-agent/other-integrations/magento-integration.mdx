...
For more information on this integration, see [AWS IAM integration](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-iam-monitoring-integration)
    ...
    <Step>
        ...
        For example, to view the total registered customers on your Magento platform, query the following:
...
<Step>
    ...
    To view your Magento app data, add our pre-built dashboard named “Magento Business Insights” to your account, go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards** and search for "Magento". You should see our pre-build dashboard named “Magento Business Insights”. Click on it to add it to your account.
