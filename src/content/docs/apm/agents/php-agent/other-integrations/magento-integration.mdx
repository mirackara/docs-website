...
you'll have access to a pre-built dashboard with important app metrics like page load time, server response time, transaction time, error rate, and availability.
