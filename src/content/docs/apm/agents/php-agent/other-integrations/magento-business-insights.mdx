...
tags:
    ...
    - Magento
metaDescription: Monitor your Magento application's performance with our comprehensive Magento business insights dashboard. Track key metrics like page load time, server response time, transaction time, error rate, and availability.
---

import apmMagentoDashboardOverview from 'images/apm_screenshot-full_magento-dashboard-overview.png'

Our Magento business insights dashboard provides a comprehensive view of your Magento ecommerce application's performance. With the dashboard, you can easily monitor key metrics like page load time, server response time, transaction time, error rate, and availability. You can also use the dashboard to diagnose issues in your app's performance and optimize your code.
...
To start monitoring your Magento app in New Relic, follow these steps to send your Magento app data to New Relic and view it in the Magento business insights dashboard.
<Steps>
    <Step>
...
If you need to install the agent in a different way, see [Apache monitoring integration](/docs/infrastructure/host-integrations/host-integrations-list/elasticsearch/elasticsearch-integration).
    ...
    <Step>
        ...
        Our synthetic monitoring feature uses synthetic monitors to test your app in different geolocations and capture server downtime.
    ...
    <Step>
        ...
        1. Go to **[one.newrelic.com](https://one.newrelic.com/) > Add data**.
        2. Search for and click on **Integrate your AWS account**. 
...
For more information on this integration, see [AWS IAM integration](/docs/infrastructure/amazon-integrations/aws-integrations-list/aws-iam-monitoring-integration)
    ...
    <Step>
        ...
        3. [Restart the infrastructure agent](/docs/infrastructure/install-infrastructure-agent/manage-your-agent/start-stop-restart-infrastructure-agent/).
...
<Step>
    ...
    To get your Magento dashboard: 

        1. Go to **[one.newrelic.com](https://one.newrelic.com/all-capabilities) > Dashboards**.
        3. In the search bar, type "Magento business insights". The dashboard should appear. 
...
Here's an example NRQL query checking the total registered customers on your Magento platform:
