...
<Callout variant="important">
  ...
  Support for PHP versions 5.5 and 5.6 **is deprecated** as of release 10.11.0.2. We highly recommend updating to at least PHP 7.0.
</Callout>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [Drupal 6.x, 7.x, 8.x, 9.0, 9.1, 9.2, and 9.3](/docs/agents/php-agent/frameworks-libraries/drupal-specific-functionality)
      </td>
