...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [Kubernetes プラグイン](/docs/logs/forward-logs/kubernetes-plugin-log-forwarding/)または[インフラストラクチャ監視エージェントを Docker で](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring/#requirements)使用します。
      </td>
    </tr>
