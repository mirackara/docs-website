...
축하합니다! 모듈을 사용하여 Terraform 구성을 보다 유연하게 만들고 있습니다. [New Relic Terraform 제공자 문서](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs) 를 검토하여 구성을 한 단계 끌어올리는 방법을 알아보세요.