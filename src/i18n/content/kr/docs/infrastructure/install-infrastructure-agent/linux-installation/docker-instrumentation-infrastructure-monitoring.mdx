...
인프라 모니터링 에이전트가 포함된 Docker 이미지를 사용할 수도 있습니다. 자세한 내용 [은 인프라 모니터링을 위한 Docker 컨테이너를](/docs/infrastructure/install-infrastructure-agent/linux-installation/container-infrastructure-monitoring) 참조하십시오.
